...
<div id="carouselBlk">
	<div id="myCarousel" class="carousel slide" >
		<div class="carousel-inner">
		  ...
		  <div class="item">
		  <div class="container">
			<img className='imgCarosule' style="width:100% ; height:315px;cursor:pointer" src="images/carousel/2.jpg" alt=""/>
				<div class="carousel-caption">
		  ...
		  <div class="item">
		  <div class="container">
			<img className='imgCarosule' style="width:100% ; height:315px;cusrsor:pointer" src="images/carousel/3.jpg" alt=""/>
			<div class="carousel-caption">
		   ...
		   <div class="item">
		   <div class="container">
			<img className='imgCarosule' style="width:100% ; height:315px;cusrsor:pointer" src="images/carousel/4.jpg" alt=""/>
			<div class="carousel-caption">
...
<a href="product.php?id=<?php echo $row10['product_id']?>"> <div class="product">
	...
	<p class="price"><b><?php echo $row10['product_price'] ?>VNĐ</b><br><span class="discount"><strike></strike> -8%</span></p>
